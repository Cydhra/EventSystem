...
public final class EventManager {
     ...
     *
     * @param listenerClassInstance
     *         An object of a class containing event handlers
     */
     ...
     *
     * @param eventType
     *         the event type that listener should handle
     * @param listener
     *         the listener method
     */
     ...
     *
     * @param listenerClassInstance
     *         An object of a class containing even handlers that has been registered at the event handler
     */
     ...
     *
     * @param scoped
     *         whether the event is scoped
     * @param scope
     *         the event's scope
     * @param typed
     *         whether the event is typed
     * @param type
     *         the event's type
     * @param event
     *         the event
     * @param priority
     *         the current dispatched priority
     */
    ...
    private static class Listener {
         ...
         * @param scopeGroup
         *         the handler scope (group)
         * @param priority
         *         the listener priority
         * @param listenedEventType
         *         the event type for typed events
         */
